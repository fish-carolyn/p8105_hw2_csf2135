...
_The total weight of trash collected by Professor Trash Wheel was `r sum(filter(all_trash, dumpster_name == "Prof. Trash Wheel")  |>  pull(weight_tons)  |> round(digits = 2))` tons._


What was the total number of cigarette butts collected by Gwynnda in July of 2021?

_In July of 2021. Gwynnda collected `r sum(filter(all_trash, dumpster_name == "Gwynnda Trash Wheel" & month == "July" & year == 2021)  |>  pull(cigarette_butts)  |>  round(digits = 2))` cigarette butts._
